...
<?php
    ...
    $COMMON = new Common($debug);
      ...
      $User = $_SESSION["UserN"];
//gets Advisors information from mySQL
    ...
    elseif($_POST["type"] == 'Individual') { displayIndividual($id, $date); }//if individual app
    elseif($_POST["type"] == 'Group') { displayGroup($id, $date); }//if group app
...
?>
    ...
    <input type="button" name="print" class="button large go" value="Print" onClick="window.print()"> <!-- prints the current window which is the layout of appointments and students signed up -->
    </form>
