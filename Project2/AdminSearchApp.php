...
<html lang="en">
  ...
  <body>
	...
	<!-- confirm function posts search query to AdminSearchResults -->
	    ...
	    <div class="field">
	      <label for="time">Time</label><span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif;"> <!-- checkboxes for times -->
	    ...
	    <div class="field">
	      <label for="advisor">Advisor</label> <!--select which advisor or group-->
	...
	<!-- causes Confirm function to take place -->
