  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <div class="field">
		<!-- SearchApp function that searches for a specific appointment and posts that choice to 11StudSearchResult.php -->
		<form action="11StudSearchResult.php" method="post" name="SearchApp">
			...
			<label for="advisor">Advisor</label>
	      	<select id="advisor" name="advisor">
				...
				<?php
				//reads in from mySQL advisors table in order for user to pick advisor
		...
		<!-- Submits the options specified by the user -->
	...
	<!-- provides option for user to cancel and return to home page -->
