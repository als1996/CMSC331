...
<!-- this includes the css file -->
  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <?php
			...
			//prints out to the user their current appointment
	...
	<!-- gives the user two options: to either cancel or keep their appointment. Returns their choice to StudProcessCancel.php -->
