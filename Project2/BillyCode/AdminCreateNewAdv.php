  ...
  <head>
   ...
   <body>
    ...
    ?>
        ...
        <!-- davies4 10-22-2015 added in the office location parameter. -->
        <div class="field">
                <label for="AdvOF">Office Location: </label>
                <input id-="AdvOF" size="20" maxlength="50" type="text" name="AdvOF" required>
        </div>
