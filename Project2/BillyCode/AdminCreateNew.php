    ...
    <div id="login">
      <div id="form">
		...
		<?php
			...
			$user = $_SESSION["AdvUN"];
			$pass = $_SESSION["AdvPW"];
            // ************ davies4 added the office parameter
            $office = $_SESSION["AdvOF"];
      ...
      if($row){
        echo("<h3>Advisor $first $last already exists</h3>");
            ...
            // *************** davies4 10-22-2015 added the office location parameter to be passed into the db.
  			$sql = "INSERT INTO `Proj2Advisors`(`FirstName`, `LastName`, `Username`, `Password`, `OfficeLocation`) 
