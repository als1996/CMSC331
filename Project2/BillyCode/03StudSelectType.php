...
<html lang="en">
  ...
  <body>
	...
	<div class="nextButton">
        ...
        <br>
        <input type="submit" name="type" class="button large go" value="Next Individual">
		<input type="submit" name="type" class="button large go" value="Next Group" style="float: right;">
