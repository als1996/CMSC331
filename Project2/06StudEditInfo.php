  ...
  <body>
    <div id="login">
      <div id="form">
        ...
        <!-- gives the fields for the student to make changes to their current information -->

            <div class="top">
            <h1>Edit Student Information<span class="login-create"></span></h1>

        <!-- this function allows the user to change information which then is posted to StudProcessEdit.php to make changes -->
            ...
            <div class="field">
                ...
                <input id="studID" size="30" maxlength="7" type="text" pattern="[A-Za-z]{2}[0-9]{5}" title="AB12345" name="studID" value=<?php echo $studID?>>
            </div>
            <div class="field">
            ...
            <div class="field">
                  ...
                  <select id="major" name = "major">
                    <option <?php if($major == 'CENG'){echo("selected");}?> value="CMPE">Computer Engineering</option>
...
-->
            ...
            <!-- this confirms the changes and update the mySQL tables with the new information -->
